...
vr_rbe = VotingRegressor(estimators=[('gb', gbr_rbe), ('rf', rf_rbe)])
...
vr_alpha = VotingRegressor(estimators=[('gb',gbr_alpha),('rf',rf_alpha)])
...
vr_beta = VotingRegressor(estimators=[('gb',gbr_beta),('rf',rf_beta)])
